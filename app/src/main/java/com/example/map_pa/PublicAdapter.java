...
public class PublicAdapter extends RecyclerView.Adapter<PublicAdapter.PublicViewHolder> {
    ...
    PublicAdapter(ArrayList<Metadata> arrayList, Context context){
    ...
    public PublicViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        PublicViewHolder holder = new PublicViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull final PublicViewHolder holder, int position) {
